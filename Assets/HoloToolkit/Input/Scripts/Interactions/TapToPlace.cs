...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class TapToPlace : MonoBehaviour, IInputClickHandler
    {
        ...
        private bool isTankPlaced = false;
        [SerializeField] private GameObject spatialMappingObject, bubbleSpawner, bubbleDestroyer, waterSurface;
        /// <summary>
        ...
        protected virtual void Start()
        {
            ...
            bubbleDestroyer.SetActive(false);
            if (PlaceParentOnTap)
            {
...
//#if UNITY_EDITOR
        private void MoveTank()
        {
            if (isTankPlaced)
            {
                //gameObject.transform.position = gameObject.transform.position + tankDisplacement;
                gameObject.GetComponent<TapToPlace>().enabled = false;
                spatialMappingObject.SetActive(false);
                bubbleSpawner.SetActive(true);
                bubbleDestroyer.SetActive(true);
                waterSurface.transform.rotation = gameObject.transform.rotation;
            }
        }
//#endif
